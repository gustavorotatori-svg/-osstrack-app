...
export default async function ProfessorAlunoDetalhePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (aluno.professorId !== session.user.id) {
    notFound()
  }
  ...
  return (
    <>
      <BackButton href="/dashboard/professor/alunos" />
      <AlunoDetalheClient
        role="professor"
        aluno={{
          id: aluno.id,
