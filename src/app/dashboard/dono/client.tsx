        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 enter-stagger">
            <div className="stat-card">
              ...
              <div className="text-xs text-[var(--white-muted)] mt-1 uppercase tracking-wide">Alunos</div>
            </div>
            <div className="stat-card">
              <div className="text-xl mb-1">👨‍🏫</div>
              <div className="text-3xl font-extrabold text-emerald-500"><AnimatedCounter value={stats.totalProfessores} /></div>
              <div className="text-xs text-[var(--white-muted)] mt-1 uppercase tracking-wide">Professores</div>
            </div>
            <div className="stat-card">
            ...
            <div className="stat-card">
              ...
              <div className="text-xs text-[var(--white-muted)] mt-1 uppercase tracking-wide">Este Mês</div>
            </div>
          </div>
          ...
          {tab === "geral" && (
            <div className="space-y-3">
              ...
              <div className="glass-card">
                <h3 className="font-bold text-base tracking-tight mb-3">📋 Presenças Recentes</h3>
                {presencas.length === 0 ? (
              ...
              <div className="glass-card">
                <h3 className="font-bold text-base tracking-tight mb-3">🥋 Alunos por Faixa</h3>
                {alunos.length === 0 ? (
          ...
          {tab === "alunos" && (
            <div className="glass-card">
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-bold text-base tracking-tight">👥 Todos os Alunos</h3>
          ...
          {tab === "graduacoes" && (
            <div className="glass-card">
              <h3 className="font-bold text-base tracking-tight mb-4">🥋 Regras de Graduação</h3>
              {graduacoes.length === 0 ? (
                <div className="empty-premium">
                  <div className="empty-premium-icon emoji-glow">🥋</div>
