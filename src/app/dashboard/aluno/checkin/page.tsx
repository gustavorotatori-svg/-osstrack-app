      ...
      <PageTransition>
        <div className="max-w-5xl mx-auto space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className={`glass-card p-4 text-center ${streak >= 10 ? "animate-fire-glow" : ""}`} style={{borderColor: streak >= 10 ? 'rgba(255,140,0,0.2)' : undefined}}>
