    ...
    <section className="relative min-h-screen flex items-center justify-center px-5 pt-24 md:pt-36 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        >
          ...
          O diário de bordo do Jiu-Jitsu
        </motion.div>
        ...
        >
          ...
          >
            <span className="relative z-10 font-bold">Começar Grátis</span>
        ...
        >
          {[
            { target: 500, suffix: "+", label: "Academias" },
            { target: 15000, suffix: "+", label: "Alunos ativos" },
            { target: 98, suffix: "%", label: "Retenção" },
          ].map((stat, i) => (
            <div key={stat.label}>
